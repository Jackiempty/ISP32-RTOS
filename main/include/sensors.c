...
void sensors_task() {
  ...
  ESP_LOGI(TAG, "%lu,%f,%f,%ld,%ld,%f,%f,%f,%f,%f,%f,%f\n", systick, pressure_altitude_instance->relative_altitude,
           pressure_altitude_instance->velocity, gps_instance->longitude, gps_instance->latitude,
           gps_instance->altitude, imu_instance->a.x, imu_instance->a.y, imu_instance->a.z, imu_instance->g.x,
           imu_instance->g.y, imu_instance->g.z);
